...
{
    return (src_op_line *) malloc(sizeof(src_op_line));
}
...
/* varify_op_syntax: the function examines the numer of operands for each
...
void varify_op_syntax(src_op_line *srcline, char *first_op,
					...
					char *second_op, char *cmd)
{
    ...
    varify_op_syntax(srcline, first_op, second_op, cmd); /* check for errors */
}
